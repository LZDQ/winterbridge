...
public class ModConfig {
    ...
    static {
        ...
        use_epearl = BUILDER
                .comment("Whether instantly use ender pearl after switching to it")
                .define("use_eperal", false);

        use_fireball = BUILDER
                .comment("Whether instantly use fireball after switching to it")
                .define("use_fireball", false);
