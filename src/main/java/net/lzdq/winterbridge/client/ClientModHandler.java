...
public class ClientModHandler {
	...
	public static void registerKeys(RegisterKeyMappingsEvent event){
		...
		event.register(ModKeyBindings.INSTANCE.KEY_E);
		event.register(ModKeyBindings.INSTANCE.KEY_AUTO_LOGIN);
		event.register(ModKeyBindings.INSTANCE.KEY_AUTO_WHO);
		event.register(ModKeyBindings.INSTANCE.KEY_RUSHING_TNT);
		event.register(ModKeyBindings.INSTANCE.KEY_RUSHING_BLOCKIN);
		event.register(ModKeyBindings.INSTANCE.KEY_RUSHING_HARD_BLOCK);
	}
